<div class="flex flex-col w-[300px] mx-auto py-16">
    {{-- Nothing in the world is as soft and yielding as water. --}}
     <div class="flex gap-4 justify-between">
        <input type="text" wire:model="todoText" wire:keydown.enter="addTodo" placeholder="type and enter your todo" class="flex-1">
        <button 
          class="py-2 px-4 bg-green-600 hover:bg-green-400 rounded text-white"
         wire:click="addTodo"
         >Add
        </button>
    </div>
    ...
    <div class="py-6">
        @if(count($todos) == 0)
             <p class="text-gray-500 ">No todos added yet!</p>
        @endif
